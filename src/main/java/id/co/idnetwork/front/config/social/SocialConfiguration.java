package id.co.idnetwork.front.config.social;

import id.co.idnetwork.front.repository.SocialUserConnectionRepository;
import id.co.idnetwork.front.repository.CustomSocialUsersConnectionRepository;
import id.co.idnetwork.front.security.jwt.TokenProvider;
import id.co.idnetwork.front.security.social.CustomSignInAdapter;
