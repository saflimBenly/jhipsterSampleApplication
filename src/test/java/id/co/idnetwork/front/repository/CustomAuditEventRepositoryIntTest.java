package id.co.idnetwork.front.repository;

import id.co.idnetwork.front.JhipsterSampleApplicationApp;
import id.co.idnetwork.front.config.Constants;
import id.co.idnetwork.front.config.audit.AuditEventConverter;
import id.co.idnetwork.front.domain.PersistentAuditEvent;
...
import static id.co.idnetwork.front.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
