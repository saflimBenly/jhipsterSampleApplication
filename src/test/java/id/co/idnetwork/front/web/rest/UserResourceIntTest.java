package id.co.idnetwork.front.web.rest;

import id.co.idnetwork.front.JhipsterSampleApplicationApp;
import id.co.idnetwork.front.domain.Authority;
import id.co.idnetwork.front.domain.User;
import id.co.idnetwork.front.repository.UserRepository;
import id.co.idnetwork.front.repository.search.UserSearchRepository;
import id.co.idnetwork.front.security.AuthoritiesConstants;
import id.co.idnetwork.front.service.MailService;
import id.co.idnetwork.front.service.UserService;
import id.co.idnetwork.front.service.dto.UserDTO;
import id.co.idnetwork.front.service.mapper.UserMapper;
import id.co.idnetwork.front.web.rest.errors.ExceptionTranslator;
import id.co.idnetwork.front.web.rest.vm.ManagedUserVM;
